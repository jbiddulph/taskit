...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | When set to true, this will force all URLs generated by Laravel to use
    | HTTPS instead of HTTP. This is useful for production environments
    | where you want to ensure all assets are served over HTTPS.
    |
    */
