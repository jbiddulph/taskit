...
This action CANNOT be undone. Are you absolutely sure?`))try{await U2.deleteProjectWithTodos(f.id);const A=a.value.findIndex(_=>_.id===f.id);A!==-1&&a.value.splice(A,1),o.value?.id===f.id&&(o.value=null,localStorage.removeItem("currentProjectId")),console.log(`Project "${f.name}" and ${I} todos deleted successfully`),window.dispatchEvent(new CustomEvent("todoChanged")),window.$notify&&window.$notify({type:"success",title:"Project Deleted",message:`Project "${f.name}" and ${I} todos have been deleted successfully.`})}catch(A){console.error("Failed to delete project with todos:",A),window.$notify&&window.$notify({type:"error",title:"Delete Failed",message:"Failed to delete project. Please try again."})}}else if(confirm(`Are you sure you want to delete "${f.name}"? This action cannot be undone.`))try{await U2.deleteProject(f.id);const q=a.value.findIndex(A=>A.id===f.id);q!==-1&&a.value.splice(q,1),o.value?.id===f.id&&(o.value=null,localStorage.removeItem("currentProjectId")),console.log(`Project "${f.name}" deleted successfully`),window.dispatchEvent(new CustomEvent("todoChanged")),window.$notify&&window.$notify({type:"success",title:"Project Deleted",message:`Project "${f.name}" has been deleted successfully.`})}catch(q){console.error("Failed to delete project:",q),window.$notify&&window.$notify({type:"error",title:"Delete Failed",message:"Failed to delete project. Please try again."})}},h=()=>{window.dispatchEvent(new CustomEvent("openCreateProjectModal"))},s=P(null),y=P(null),p=(f,g)=>{s.value=g,f.dataTransfer&&(f.dataTransfer.effectAllowed="move",f.dataTransfer.setData("text/plain",g.id.toString()))},u=(f,g)=>{f.preventDefault(),f.dataTransfer&&(f.dataTransfer.dropEffect="move"),y.value=g},m=()=>{y.value=null},v=async(f,g)=>{if(f.preventDefault(),y.value=null,!s.value)return;const I=a.value.findIndex(R=>R.id===s.value.id);if(I===-1||I===g){s.value=null;return}const q=[...a.value],[A]=q.splice(I,1);q.splice(g,0,A);const _=q.map((R,V)=>({id:R.id,viewing_order:V+1}));try{await U2.updateProjectOrder(_),a.value=q,window.$notify&&window.$notify({type:"success",title:"Project Order Updated",message:"Projects have been reordered successfully."})}catch(R){console.error("Failed to update project order:",R),window.$notify&&window.$notify({type:"error",title:"Update Failed",message:"Failed to reorder projects. Please try again."})}s.value=null},C=()=>{s.value=null,y.value=null};return(f,g)=>(k(),L(i(Pb),{class:"px-2 py-0"},{default:M(()=>[b(i(zb),null,{default:M(()=>g[0]||(g[0]=[he("Projects",-1)])),_:1,__:[0]}),b(i(Ag),null,{default:M(()=>[b(i(H2),null,{default:M(()=>[b(i(z2),{onClick:h,tooltip:"Create New Project"},{default:M(()=>[b(de,{name:"Plus",class:"w-4 h-4"}),g[1]||(g[1]=z("span",null,"New Project",-1))]),_:1,__:[1]})]),_:1}),(k(!0),D(me,null,$m(a.value,(I,q)=>(k(),L(i(H2),{key:I.id,onDragover:A=>u(A,q),onDragleave:m,onDrop:A=>v(A,q),class:U({"drag-over":y.value===q})},{default:M(()=>[b(i(z2),{onClick:A=>d(I),"is-active":o.value?.id===I.id,tooltip:I.name,class:U(["group relative",{"selected-project":o.value?.id===I.id}]),style:f2(o.value?.id===I.id?{borderTop:`1px solid ${I.color}`,borderLeft:`1px solid ${I.color}`,borderBottom:`1px solid ${I.color}`,borderRight:"none",marginRight:"-2px",borderRadius:"15px 0px 0px 15px"}:{})},{default:M(()=>[z("div",Qb,[z("div",{class:"w-3 h-3 rounded-full flex-shrink-0 cursor-move hover:scale-110 transition-transform",style:f2({backgroundColor:I.color}),draggable:"true",onDragstart:A=>p(A,I),onDragend:C,title:"Drag to reorder"},null,44,Jb),z("span",Yb,W(I.name),1),z("span",eq,W(I.total_todos||0),1),z("div",tq,[z("button",{onClick:A=>l(I,A),class:"text-gray-400 hover:text-red-500 transition-colors",tooltip:`Delete ${I.name}`},[b(de,{name:"Trash2",class:"w-3 h-3"})],8,aq)])])]),_:2},1032,["onClick","is-active","tooltip","class","style"])]),_:2},1032,["onDragover","onDrop","class"]))),128)),n.value?(k(),L(i(H2),{key:0},{default:M(()=>[b(i(z2),{disabled:""},{default:M(()=>[b(de,{name:"Loader2",class:"w-4 h-4 animate-spin"}),g[2]||(g[2]=z("span",null,"Loading...",-1))]),_:1,__:[2]})]),_:1})):X("",!0)]),_:1})]),_:1}))}}),nq=TI(oq,[["__scopeId","data-v-41427f0f"]]),cq=x({__name:"Avatar",props:{class:{}},setup(t){const a=t;return(o,n)=>(k(),L(i(Hw),{"data-slot":"avatar",class:U(i(T)("relative flex size-8 shrink-0 overflow-hidden rounded-full",a.class))},{default:M(()=>[w(o.$slots,"default")]),_:3},8,["class"]))}}),rq=x({__name:"AvatarFallback",props:{delayMs:{},asChild:{type:Boolean},as:{},class:{}},setup(t){const a=t,o=H(()=>{const{class:n,...c}=a;return c});return(n,c)=>(k(),L(i(Bw),B({"data-slot":"avatar-fallback"},o.value,{class:i(T)("bg-muted flex size-full items-center justify-center rounded-full",a.class)}),{default:M(()=>[w(n.$slots,"default")]),_:3},16,["class"]))}}),iq=x({__name:"AvatarImage",props:{src:{},referrerPolicy:{},crossOrigin:{},asChild:{type:Boolean},as:{}},setup(t){const a=t;return(o,n)=>(k(),L(i(jw),B({"data-slot":"avatar-image"},a,{class:"aspect-square size-full"}),{default:M(()=>[w(o.$slots,"default")]),_:3},16))}});function dq(t){if(!t)return"";const a=t.trim().split(" ");return a.length===0?"":a.length===1?a[0].charAt(0).toUpperCase():`${a[0].charAt(0)}${a[a.length-1].charAt(0)}`.toUpperCase()}function lq(){return{getInitials:dq}}const hq={class:"grid flex-1 text-left text-sm leading-tight"},sq={class:"truncate font-medium"},yq={key:0,class:"truncate text-xs text-muted-foreground"},RI=x({__name:"UserInfo",props:{user:{},showEmail:{type:Boolean,default:!1}},setup(t){const a=t,{getInitials:o}=lq(),n=H(()=>a.user.avatar&&a.user.avatar!=="");return(c,r)=>(k(),D(me,null,[b(i(cq),{class:"h-8 w-8 overflow-hidden rounded-lg"},{default:M(()=>[n.value?(k(),L(i(iq),{key:0,src:c.user.avatar,alt:c.user.name},null,8,["src","alt"])):X("",!0),b(i(rq),{class:"rounded-lg text-black dark:text-white"},{default:M(()=>[he(W(i(o)(c.user.name)),1)]),_:1})]),_:1}),z("div",hq,[z("span",sq,W(c.user.name),1),c.showEmail?(k(),D("span",yq,W(c.user.email),1)):X("",!0)])],64))}}),pq=x({__name:"DropdownMenu",props:{defaultOpen:{type:Boolean},open:{type:Boolean},dir:{},modal:{type:Boolean}},emits:["update:open"],setup(t,{emit:a}){const c=ue(t,a);return(r,d)=>(k(),L(i(zC),B({"data-slot":"dropdown-menu"},i(c)),{default:M(()=>[w(r.$slots,"default")]),_:3},16))}}),uq=x({__name:"DropdownMenuContent",props:{forceMount:{type:Boolean},loop:{type:Boolean},side:{},sideOffset:{default:4},sideFlip:{type:Boolean},align:{},alignOffset:{},alignFlip:{type:Boolean},avoidCollisions:{type:Boolean},collisionBoundary:{},collisionPadding:{},arrowPadding:{},sticky:{},hideWhenDetached:{type:Boolean},positionStrategy:{},updatePositionStrategy:{},disableUpdateOnLayoutShift:{type:Boolean},prioritizePosition:{type:Boolean},reference:{},asChild:{type:Boolean},as:{},class:{}},emits:["escapeKeyDown","pointerDownOutside","focusOutside","interactOutside","closeAutoFocus"],setup(t,{emit:a}){const o=t,n=a,c=H(()=>{const{class:d,...l}=o;return l}),r=ue(c,n);return(d,l)=>(k(),L(i(OC),null,{default:M(()=>[b(i(DC),B({"data-slot":"dropdown-menu-content"},i(r),{class:i(T)("bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 max-h-(--reka-dropdown-menu-content-available-height) min-w-[8rem] origin-(--reka-dropdown-menu-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-md border p-1 shadow-md",o.class)}),{default:M(()=>[w(d.$slots,"default")]),_:3},16,["class"])]),_:3}))}}),kq=x({__name:"DropdownMenuGroup",props:{asChild:{type:Boolean},as:{}},setup(t){const a=t;return(o,n)=>(k(),L(i(_C),B({"data-slot":"dropdown-menu-group"},a),{default:M(()=>[w(o.$slots,"default")]),_:3},16))}}),Xg=x({__name:"DropdownMenuItem",props:{disabled:{type:Boolean},textValue:{},asChild:{type:Boolean},as:{},class:{},inset:{type:Boolean},variant:{default:"default"}},setup(t){const a=t,o=Zm(a,"inset","variant"),n=Nm(o);return(c,r)=>(k(),L(i(jC),B({"data-slot":"dropdown-menu-item","data-inset":c.inset?"":void 0,"data-variant":c.variant},i(n),{class:i(T)("focus:bg-accent focus:text-accent-foreground data-[variant=destructive]:text-destructive-foreground data-[variant=destructive]:focus:bg-destructive/10 dark:data-[variant=destructive]:focus:bg-destructive/40 data-[variant=destructive]:focus:text-destructive-foreground data-[variant=destructive]:*:[svg]:!text-destructive-foreground [&_svg:not([class*='text-'])]:text-muted-foreground relative flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",a.class)}),{default:M(()=>[w(c.$slots,"default")]),_:3},16,["data-inset","data-variant","class"]))}}),Mq=x({__name:"DropdownMenuLabel",props:{asChild:{type:Boolean},as:{},class:{},inset:{type:Boolean}},setup(t){const a=t,o=Zm(a,"class","inset"),n=Nm(o);return(c,r)=>(k(),L(i(TC),B({"data-slot":"dropdown-menu-label","data-inset":c.inset?"":void 0},i(n),{class:i(T)("px-2 py-1.5 text-sm font-medium data-[inset]:pl-8",a.class)}),{default:M(()=>[w(c.$slots,"default")]),_:3},16,["data-inset","class"]))}}),Kg=x({__name:"DropdownMenuSeparator",props:{asChild:{type:Boolean},as:{},class:{}},setup(t){const a=t,o=H(()=>{const{class:n,...c}=a;return c});return(n,c)=>(k(),L(i(EC),B({"data-slot":"dropdown-menu-separator"},o.value,{class:i(T)("bg-border -mx-1 my-1 h-px",a.class)}),null,16,["class"]))}}),fq=x({__name:"DropdownMenuTrigger",props:{disabled:{type:Boolean},asChild:{type:Boolean},as:{}},setup(t){const o=Nm(t);return(n,c)=>(k(),L(i(ZC),B({"data-slot":"dropdown-menu-trigger"},i(o)),{default:M(()=>[w(n.$slots,"default")]),_:3},16))}}),oe=t=>({url:oe.url(t),method:"get"});oe.definition={methods:["get","head"],url:"/settings/profile"};oe.url=t=>oe.definition.url+Mg(t);oe.get=t=>({url:oe.url(t),method:"get"});oe.head=t=>({url:oe.url(t),method:"head"});const Pg=t=>({action:oe.url(t),method:"get"});Pg.get=t=>({action:oe.url(t),method:"get"});Pg.head=t=>({action:oe.url({[t?.mergeQuery?"mergeQuery":"query"]:{_method:"HEAD",...t?.query??t?.mergeQuery??{}}}),method:"get"});oe.form=Pg;const be=t=>({url:be.url(t),method:"patch"});be.definition={methods:["patch"],url:"/settings/profile"};be.url=t=>be.definition.url+Mg(t);be.patch=t=>({url:be.url(t),method:"patch"});const OI=t=>({action:be.url({[t?.mergeQuery?"mergeQuery":"query"]:{_method:"PATCH",...t?.query??t?.mergeQuery??{}}}),method:"post"});OI.patch=t=>({action:be.url({[t?.mergeQuery?"mergeQuery":"query"]:{_method:"PATCH",...t?.query??t?.mergeQuery??{}}}),method:"post"});be.form=OI;const qe=t=>({url:qe.url(t),method:"delete"});qe.definition={methods:["delete"],url:"/settings/profile"};qe.url=t=>qe.definition.url+Mg(t);qe.delete=t=>({url:qe.url(t),method:"delete"});const UI=t=>({action:qe.url({[t?.mergeQuery?"mergeQuery":"query"]:{_method:"DELETE",...t?.query??t?.mergeQuery??{}}}),method:"post"});UI.delete=t=>({action:qe.url({[t?.mergeQuery?"mergeQuery":"query"]:{_method:"DELETE",...t?.query??t?.mergeQuery??{}}}),method:"post"});qe.form=UI;const vq={class:"flex items-center gap-2 px-1 py-1.5 text-left text-sm"},mq=x({__name:"UserMenuContent",props:{user:{}},setup(t){const a=()=>{rx.flushAll()};return(o,n)=>(k(),D(me,null,[b(i(Mq),{class:"p-0 font-normal"},{default:M(()=>[z("div",vq,[b(RI,{user:o.user,"show-email":!0},null,8,["user"])])]),_:1}),b(i(Kg)),b(i(kq),null,{default:M(()=>[b(i(Xg),{"as-child":!0},{default:M(()=>[b(i(Fm),{class:"block w-full",href:i(oe)(),prefetch:"",as:"button"},{default:M(()=>[b(i(A2),{class:"mr-2 h-4 w-4"}),n[0]||(n[0]=he(" Settings ",-1))]),_:1,__:[0]},8,["href"])]),_:1})]),_:1}),b(i(Kg)),b(i(Xg),{"as-child":!0},{default:M(()=>[b(i(Fm),{class:"block w-full",href:i(vx)(),onClick:a,as:"button"},{default:M(()=>[b(i(S2),{class:"mr-2 h-4 w-4"}),n[1]||(n[1]=he(" Log out ",-1))]),_:1,__:[1]},8,["href"])]),_:1})],64))}}),gq=x({__name:"NavUser",setup(t){const o=kg().props.auth.user,{isMobile:n,state:c}=eg();return(r,d)=>(k(),L(i(Ag),null,{default:M(()=>[b(i(H2),null,{default:M(()=>[b(i(pq),null,{default:M(()=>[b(i(fq),{"as-child":""},{default:M(()=>[b(i(z2),{size:"lg",class:"data-[state=open]:bg-sidebar-accent data-[state=open]:text-sidebar-accent-foreground"},{default:M(()=>[b(RI,{user:i(o)},null,8,["user"]),b(i(b2),{class:"ml-auto size-4"})]),_:1})]),_:1}),b(i(uq),{class:"w-(--reka-dropdown-menu-trigger-width) min-w-56 rounded-lg",side:i(n)?"bottom":i(c)==="collapsed"?"left":"bottom",align:"end","side-offset":4},{default:M(()=>[b(mq,{user:i(o)},null,8,["user"])]),_:1},8,["side"])]),_:1})]),_:1})]),_:1}))}}),Iq={class:"flex aspect-square size-8 items-center justify-center rounded-md bg-sidebar-primary text-sidebar-primary-foreground"},xq=x({__name:"AppLogo",setup(t){return(a,o)=>(k(),D(me,null,[z("div",Iq,[b(WI,{class:"size-5 fill-current text-white dark:text-black"})]),o[0]||(o[0]=z("div",{class:"ml-1 grid flex-1 text-left text-sm"},[z("span",{class:"mb-0.5 truncate leading-tight font-semibold"},"TaskIT")],-1))],64))}}),wq={class:"border-t border-gray-200 dark:border-gray-700 pt-4"},Lq=x({__name:"AppSidebar",setup(t){return(a,o)=>(k(),D(me,null,[b(i(qb),{collapsible:"icon",variant:"inset"},{default:M(()=>[b(i(Hb),null,{default:M(()=>[b(i(Ag),null,{default:M(()=>[b(i(H2),null,{default:M(()=>[b(i(z2),{size:"lg","as-child":""},{default:M(()=>[b(i(Fm),{href:i(mx)()},{default:M(()=>[b(xq)]),_:1},8,["href"])]),_:1})]),_:1})]),_:1})]),_:1}),b(i(Sb),null,{default:M(()=>[b(nq)]),_:1}),b(i(Ab),null,{default:M(()=>[z("div",wq,[b(gq)])]),_:1})]),_:1}),w(a.$slots,"default")],64))}}),Cq=x({__name:"Breadcrumb",props:{class:{}},setup(t){const a=t;return(o,n)=>(k(),D("nav",{"aria-label":"breadcrumb","data-slot":"breadcrumb",class:U(a.class)},[w(o.$slots,"default")],2))}}),bq=x({__name:"BreadcrumbItem",props:{class:{}},setup(t){const a=t;return(o,n)=>(k(),D("li",{"data-slot":"breadcrumb-item",class:U(i(T)("inline-flex items-center gap-1.5",a.class))},[w(o.$slots,"default")],2))}}),qq=x({__name:"BreadcrumbLink",props:{asChild:{type:Boolean},as:{default:"a"},class:{}},setup(t){const a=t;return(o,n)=>(k(),L(i(Z),{"data-slot":"breadcrumb-link",as:o.as,"as-child":o.asChild,class:U(i(T)("hover:text-foreground transition-colors",a.class))},{default:M(()=>[w(o.$slots,"default")]),_:3},8,["as","as-child","class"]))}}),Sq=x({__name:"BreadcrumbList",props:{class:{}},setup(t){const a=t;return(o,n)=>(k(),D("ol",{"data-slot":"breadcrumb-list",class:U(i(T)("text-muted-foreground flex flex-wrap items-center gap-1.5 text-sm break-words sm:gap-2.5",a.class))},[w(o.$slots,"default")],2))}}),Aq=x({__name:"BreadcrumbPage",props:{class:{}},setup(t){const a=t;return(o,n)=>(k(),D("span",{"data-slot":"breadcrumb-page",role:"link","aria-disabled":"true","aria-current":"page",class:U(i(T)("text-foreground font-normal",a.class))},[w(o.$slots,"default")],2))}}),Pq=x({__name:"BreadcrumbSeparator",props:{class:{}},setup(t){const a=t;return(o,n)=>(k(),D("li",{"data-slot":"breadcrumb-separator",role:"presentation","aria-hidden":"true",class:U(i(T)("[&>svg]:size-3.5",a.class))},[w(o.$slots,"default",{},()=>[b(i(C2))])],2))}}),zq=x({__name:"Breadcrumbs",props:{breadcrumbs:{}},setup(t){return(a,o)=>(k(),L(i(Cq),null,{default:M(()=>[b(i(Sq),null,{default:M(()=>[(k(!0),D(me,null,$m(a.breadcrumbs,(n,c)=>(k(),D(me,{key:c},[b(i(bq),null,{default:M(()=>[c===a.breadcrumbs.length-1?(k(),L(i(Aq),{key:0},{default:M(()=>[he(W(n.title),1)]),_:2},1024)):(k(),L(i(qq),{key:1,"as-child":""},{default:M(()=>[b(i(Fm),{href:n.href??"#"},{default:M(()=>[he(W(n.title),1)]),_:2},1032,["href"])]),_:2},1024))]),_:2},1024),c!==a.breadcrumbs.length-1?(k(),L(i(Pq),{key:0})):X("",!0)],64))),128))]),_:1})]),_:1}))}}),Hq={key:0,class:"flex items-center gap-4"},Dq={class:"flex items-center gap-2"},Bq=["title"],_q={class:"font-semibold"},Vq={key:0,class:"flex items-center gap-2"},jq=x({__name:"CompanyCodeDisplay",props:{companyCode:{},companyName:{},subscriptionType:{}},setup(t){const a=t,o=P(!1),n=async()=>{if(a.companyCode)try{await navigator.clipboard.writeText(a.companyCode),o.value=!0,setTimeout(()=>{o.value=!1},2e3)}catch(c){console.error("Failed to copy: ",c)}};return(c,r)=>c.companyCode?(k(),D("div",Hq,[z("div",Dq,[r[0]||(r[0]=z("div",{class:"text-xs text-gray-500 dark:text-gray-400"}," Company Code: ",-1)),z("button",{onClick:n,class:"flex items-center gap-1 px-2 py-1 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md text-xs font-mono text-blue-700 dark:text-blue-300 hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors",title:`Click to copy company code: ${c.companyCode}`},[z("span",_q,W(c.companyCode),1),(k(),L(Em(o.value?i(L2):i(q2)),{size:12,class:"text-blue-600 dark:text-blue-400"}))],8,Bq)]),c.subscriptionType?(k(),D("div",Vq,[r[1]||(r[1]=z("div",{class:"text-xs text-gray-500 dark:text-gray-400"}," Plan: ",-1)),z("div",{class:U(["px-2 py-1 rounded-md text-xs font-semibold",{"bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300":c.subscriptionType==="FREE","bg-blue-100 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800":c.subscriptionType==="MIDI","bg-purple-100 dark:bg-purple-900/20 text-purple-700 dark:text-purple-300 border border-purple-200 dark:border-purple-800":c.subscriptionType==="MAXI"}])},W(c.subscriptionType),3)])):X("",!0)])):X("",!0)}});class Fq{baseUrl="/notifications";async request(a,o,n){try{return(await V2({method:a,url:`${this.baseUrl}${o}`,data:n,headers:{"Content-Type":"application/json","X-Requested-With":"XMLHttpRequest"}})).data}catch(c){throw console.error(`Notification API ${a} error:`,c),new Error(c.response?.data?.message||`Failed to ${a.toLowerCase()} notification`)}}async getNotifications(a=1){return this.request("GET",`?page=${a}`)}async getUnreadCount(){return this.request("GET","/unread-count")}async markAsRead(a){return this.request("PATCH",`/${a}/read`)}async markAllAsRead(){return this.request("PATCH","/mark-all-read")}async deleteNotification(a){return this.request("DELETE",`/${a}`)}async createNotification(a){return this.request("POST","",a)}}const x2=new Fq,Tq={class:"relative"},Rq={key:0,class:"absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center font-medium animate-pulse"},Oq={key:0,class:"absolute top-full right-0 mt-2 w-80 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-50"},Uq={class:"p-4 border-b border-gray-200 dark:border-gray-700"},Eq={class:"flex items-center justify-between"},$q={class:"flex items-center gap-2"},Zq={class:"max-h-96 overflow-y-auto"},Gq={key:0,class:"p-4 text-center text-gray-500"},Wq={key:1,class:"p-4 text-center text-gray-500"},Nq={key:2},Xq={class:"flex items-start gap-3"},Kq={class:"flex-1 min-w-0"},Qq={class:"flex items-start justify-between"},Jq={class:"flex-1"},Yq={class:"text-sm font-medium text-gray-900 dark:text-gray-100"},eS={class:"text-sm text-gray-600 dark:text-gray-400 mt-1"},tS={class:"text-xs text-gray-500 dark:text-gray-500 mt-2"},aS={class:"flex items-center gap-1 ml-2"},oS=["onClick"],nS=["onClick"],cS={key:0,class:"p-4 border-t border-gray-200 dark:border-gray-700"},rS=x({__name:"NotificationBadge",setup(t){const a=P(!1),o=P([]),n=P(0),c=P(!1),r=P(1),d=async()=>{try{c.value=!0;const g=await x2.getNotifications(r.value);r.value===1?o.value=g.data:o.value.push(...g.data)}catch(g){console.error("Failed to load notifications:",g)}finally{c.value=!1}},l=async()=>{try{const g=await x2.getUnreadCount();n.value=g.count}catch(g){console.error("Failed to load unread count:",g)}},h=()=>{a.value=!a.value,a.value&&o.value.length===0&&d()},s=async g=>{try{await x2.markAsRead(g);const I=o.value.find(q=>q.id===g);I&&(I.is_read=!0,I.read_at=new Date().toISOString()),await l()}catch(I){console.error("Failed to mark notification as read:",I)}},y=async()=>{try{await x2.markAllAsRead(),o.value.forEach(g=>{g.is_read=!0,g.read_at=new Date().toISOString()}),n.value=0}catch(g){console.error("Failed to mark all notifications as read:",g)}},p=async g=>{try{await x2.deleteNotification(g),o.value=o.value.filter(I=>I.id!==g),await l()}catch(I){console.error("Failed to delete notification:",I)}},u=async()=>{r.value++,await d()},m=g=>({info:"Info",warning:"AlertTriangle",error:"XCircle",success:"CheckCircle"})[g]||"Bell",v=g=>({info:"bg-blue-100 text-blue-600 dark:bg-blue-900 dark:text-blue-400",warning:"bg-yellow-100 text-yellow-600 dark:bg-yellow-900 dark:text-yellow-400",error:"bg-red-100 text-red-600 dark:bg-red-900 dark:text-red-400",success:"bg-green-100 text-green-600 dark:bg-green-900 dark:text-green-400"})[g]||"bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400",C=g=>{const I=new Date(g),A=new Date().getTime()-I.getTime(),_=Math.floor(A/(1e3*60*60*24)),R=Math.floor(A/(1e3*60*60)),V=Math.floor(A/(1e3*60));return V<1?"Just now":V<60?`${V}m ago`:R<24?`${R}h ago`:_<7?`${_}d ago`:I.toLocaleDateString()},f=g=>{g.target.closest(".relative")||(a.value=!1)};return Ie(()=>{l(),document.addEventListener("click",f);const g=setInterval(l,3e4);Um(()=>{clearInterval(g),document.removeEventListener("click",f)})}),(g,I)=>(k(),D("div",Tq,[z("button",{onClick:h,class:"relative p-2 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100 transition-colors"},[b(de,{name:"Bell",class:"w-5 h-5"}),n.value>0?(k(),D("span",Rq,W(n.value>99?"99+":n.value),1)):X("",!0)]),a.value?(k(),D("div",Oq,[z("div",Uq,[z("div",Eq,[I[1]||(I[1]=z("h3",{class:"text-lg font-semibold text-gray-900 dark:text-gray-100"}," Notifications ",-1)),z("div",$q,[n.value>0?(k(),D("button",{key:0,onClick:y,class:"text-sm text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300"}," Mark all read ")):X("",!0),z("button",{onClick:I[0]||(I[0]=q=>a.value=!1),class:"text-gray-400 hover:text-gray-600 dark:hover:text-gray-300"},[b(de,{name:"X",class:"w-4 h-4"})])])])]),z("div",Zq,[c.value?(k(),D("div",Gq,[b(de,{name:"Loader2",class:"w-6 h-6 animate-spin mx-auto mb-2"}),I[2]||(I[2]=he(" Loading notifications... ",-1))])):o.value.length===0?(k(),D("div",Wq," No notifications yet ")):(k(),D("div",Nq,[(k(!0),D(me,null,$m(o.value,q=>(k(),D("div",{key:q.id,class:U(["p-4 border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors",{"bg-blue-50 dark:bg-blue-900/20":!q.is_read}])},[z("div",Xq,[z("div",{class:U(["flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center",v(q.type)])},[b(de,{name:m(q.type),class:"w-4 h-4"},null,8,["name"])],2),z("div",Kq,[z("div",Qq,[z("div",Jq,[z("h4",Yq,W(q.title),1),z("p",eS,W(q.message),1),z("p",tS,W(C(q.created_at)),1)]),z("div",aS,[q.is_read?X("",!0):(k(),D("button",{key:0,onClick:A=>s(q.id),class:"text-gray-400 hover:text-gray-600 dark:hover:text-gray-300",title:"Mark as read"},[b(de,{name:"Check",class:"w-4 h-4"})],8,oS)),z("button",{onClick:A=>p(q.id),class:"text-gray-400 hover:text-red-600 dark:hover:text-red-400",title:"Delete"},[b(de,{name:"Trash2",class:"w-4 h-4"})],8,nS)])])])])],2))),128))]))]),o.value.length>0?(k(),D("div",cS,[z("button",{onClick:u,class:"w-full text-sm text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300"}," Load more notifications ")])):X("",!0)])):X("",!0)]))}}),iS={class:"flex h-16 shrink-0 items-center justify-between gap-2 border-b border-sidebar-border/70 px-6 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12 md:px-4"},dS={class:"flex items-center gap-2"},lS={class:"flex items-center gap-3"},hS=x({__name:"AppSidebarHeader",props:{breadcrumbs:{default:()=>[]},company:{default:null}},setup(t){return(a,o)=>(k(),D("header",iS,[z("div",dS,[b(i(Fb),{class:"-ml-1"}),a.breadcrumbs&&a.breadcrumbs.length>0?(k(),L(zq,{key:0,breadcrumbs:a.breadcrumbs},null,8,["breadcrumbs"])):X("",!0)]),z("div",lS,[b(jq,{"company-code":a.company?.code,"company-name":a.company?.name,"subscription-type":a.company?.subscription_type},null,8,["company-code","company-name","subscription-type"]),b(rS)])]))}}),sS=x({__name:"AppSidebarLayout",props:{breadcrumbs:{default:()=>[]},company:{default:null}},setup(t){return(a,o)=>(k(),L(Xb,{variant:"sidebar"},{default:M(()=>[b(Lq),b(Rb,{variant:"sidebar",class:"overflow-x-hidden"},{default:M(()=>[b(hS,{breadcrumbs:a.breadcrumbs,company:a.company},null,8,["breadcrumbs","company"]),w(a.$slots,"default")]),_:3})]),_:3}))}}),fS=x({__name:"AppLayout",props:{breadcrumbs:{default:()=>[]},company:{default:null}},setup(t){return(a,o)=>(k(),L(sS,{breadcrumbs:a.breadcrumbs,company:a.company},{default:M(()=>[w(a.$slots,"default")]),_:3},8,["breadcrumbs","company"]))}});export{$x as D,A5 as M,q9 as S,P2 as X,de as _,TI as a,fS as b,q5 as c,Gx as d,Lw as e,qw as f,vw as g,gw as h,Se as i,Aw as j,oe as k,U2 as t};
